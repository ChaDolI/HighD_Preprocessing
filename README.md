...
With 01_tracks.csv and 01_tracksMete.csv data and highD_preprocessing_plot.m, draw_rectangle.m in the same folder, run highD_preprocessing_plot.m and you will get the same result.  
